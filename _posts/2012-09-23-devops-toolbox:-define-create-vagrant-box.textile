...
{% highlight sh linenos %}
$ vagrant basebox export MyServer --output ./boxes/MyServer.box
...
vagrant package --base 'MyServer' --output './boxes/MyServer.box'

To import it into vagrant type:
vagrant box add 'MyServer' './boxes/MyServer.box'
