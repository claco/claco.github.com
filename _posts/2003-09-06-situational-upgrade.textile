...
<p class="image">
<img src="/blog/images/hardware/newcpu-mrtg.png" alt="MRTG CPU Usage" width="400" /><br />Chart grows to the right. After 11pm, the same processes take more CPU time.
</p>
