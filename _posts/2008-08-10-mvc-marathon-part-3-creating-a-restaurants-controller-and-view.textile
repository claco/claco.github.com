...
<p><strong>Update: I dropped the ball on this one. There is the new Dynamic Data scaffolding in .NET 3.5. It appears that you can create an entirely separate Dynamic Data site, or <a href="http://msdn.microsoft.com/en-us/library/cc668188.aspx">try and work it into an existing site</a>. As it stands,  a separate site doesn't count as part of the MVC solution, and the steps to integrate it are woefully long and complicated. I declare that the same as no real new user friendly solution for the context of this series.</strong></p>
		...
		<p>
			<a href="aspnet1.png">
				<img src='aspnet1.png' width="204" height="152" alt="create data" />
			</a>
		</p>
		<p>
		...
		<p>
			<a href="aspnet2.png">
				<img src='aspnet2.png' width="204" height="152" alt="create controller" />
			</a>
		</p>
		<p>
		...
		<p>
			<a href="aspnet3.png">
				<img src='aspnet3.png' width="204" height="152" alt="new controller" />
			</a>
		</p>
		<p>
		...
		<p>
			<a href="aspnet4.png">
				<img src='aspnet4.png' width="204" height="152" alt="new controller code" />
			</a>
		</p>
		<pre>public ActionResult Index()
{
    ...
    return View(restaurants);
		...
		<p>
			<a href="aspnet5.png">
				<img src='aspnet5.png' width="204" height="152" alt="new view" />
			</a>
		</p>
		<p>
		...
		<p>
			<a href="aspnet6.png">
				<img src='aspnet6.png' width="204" height="152" alt="new view master select" />
			</a>
		</p>
		<p>
		...
		<p>
			<a href="aspnet7.png">
				<img src='aspnet7.png' width="204" height="152" alt="new view model type" />
			</a>
		</p>
		...
		<p>
			<a href="aspnet8.png">
				<img src='aspnet8.png' width="204" height="152" alt="new view model loop" />
			</a>
		</p>
		<pre>&lt;ul&gt;
...
&lt;/ul&gt;</pre>
		...
		<p>
			<a href="aspnet11.png">
				<img src='aspnet11.png' width="204" height="152" alt="new view model browser" />
			</a>
		</p>
		<p>
		...
		<p>
			<a href="aspnet9.png">
				<img src='aspnet9.png' width="204" height="152" alt="new view model browser" />
			</a>
		</p>
		<pre>&lt;li&gt;
...
&lt;/li&gt;</pre>
		...
		<p>
			<a href="aspnet10.png">
				<img src='aspnet10.png' width="204" height="152" alt="new view model browser" />
			</a>
		</p>
...
?&gt;</pre>
		...
		<p>
			<a href="cake1.png">
				<img src='cake1.png' width="204" height="152" alt="cake list" />
			</a>
			<a href="cake2.png">
				<img src='cake2.png' width="204" height="152" alt="cake new" />
			</a>
			<a href="cake3.png">
				<img src='cake3.png' width="204" height="152" alt="cake list" />
			</a>
		</p>
		<p>
		...
		<p>
			<a href="cake4.png">
				<img src='cake4.png' width="204" height="152" alt="new view model browser" />
			</a>
		</p>
...
&lt;/ul&gt;</pre>
		...
		<p>
			<a href="catalyst1.png">
				<img src='catalyst1.png' width="204" height="152" alt="catalyst browser" />
			</a>
		</p>
...
Installing index for admin.LogEntry model</pre>
		...
		<p>
			<a href="django1.png">
				<img src='django1.png' width="204" height="152" alt="django list" />
			</a>
			<a href="django2.png">
				<img src='django2.png' width="204" height="152" alt="django new" />
			</a>
			<a href="django3.png">
				<img src='django3.png' width="204" height="152" alt="django list" />
			</a>
			<a href="django4.png">
				<img src='django4.png' width="204" height="152" alt="django list" />
			</a>
		</p>
...
&lt;/ul&gt;</pre>
		...
		<p>
			<a href="django5.png">
				<img src='django5.png' width="204" height="152" alt="django browser" />
			</a>
		</p>
...
dependency  model
    ...
    create    db/migrate/20080731023309_create_restaurants.rb</pre>
		...
		<p>
			<a href="rails1.png">
				<img src='rails1.png' width="204" height="152" alt="rails list" />
			</a>
			<a href="rails2.png">
				<img src='rails2.png' width="204" height="152" alt="rails new" />
			</a>
			<a href="rails3.png">
				<img src='rails3.png' width="204" height="152" alt="rails list" />
			</a>
			<a href="rails3.png">
				<img src='rails3.png' width="204" height="152" alt="rails list" />
			</a>
